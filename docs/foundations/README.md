...
- [Commitment economy vision](./commitment-economy-vision.md): philosophy and design synthesis — economy as ecosystem, four metabolic functions, composability, dependency quality, learning loop, pattern language, concrete RC/KE transition path, situated transfer. The thinking document.
- [Commitment economy design](./commitment-economy-design.md): technical spec — two-layer architecture (pooling + TBFF), fractal structure, on-chain architecture, dependency quality signal. Companion to the vision doc.
